              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #111111; border: 1px solid #333333; border-radius: 12px; padding: 20px;">
                    ...
                    <tr>
                      <td style="font-size: 11px; color: #888888; padding-bottom: 2px;">Artículos Reservados</td>
                    </tr>
                    <tr>
                      <td style="font-size: 13px; color: #aaaaaa; padding-bottom: 12px; line-height: 1.4;">${data.merchItems}</td>
                    </tr>
                    <tr>
                      <td style="font-size: 11px; color: #888888; padding-bottom: 2px;">Total a Pagar (100%)</td>
                    </tr>
                    <tr>
            ...
            <table width="100%" max-width="500" border="0" cellspacing="0" cellpadding="0" style="max-width: 500px; background-color: #0a0a0a; border: 1px solid #222222; border-radius: 16px; padding: 32px; text-align: left;">
              ...
              <tr>
                <td align="center" style="padding: 16px 0 24px 0;">
                  <a href="${ticketUrl}" target="_blank" style="background-color: #f59e0b; color: #000000; display: inline-block; padding: 14px 28px; font-weight: bold; border-radius: 8px; text-decoration: none; font-size: 15px; letter-spacing: 0.5px;">🛒 Ver Mercancía y Reservar</a>
                </td>
              </tr>
              <tr>
                <td style="font-size: 12px; color: #888888; line-height: 1.5; padding: 20px; background-color: #111111; border: 1px dashed #333333; border-radius: 12px;">
